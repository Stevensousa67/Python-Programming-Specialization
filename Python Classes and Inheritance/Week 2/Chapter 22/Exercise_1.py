# Change the above code to allow you to adopt a Tiger pet (that you’re about to create). HINT: look at the whichtype
# function, and think about what’s happening in the code for that function.
# Now, modify the code to define a new class, Tiger. The Tiger class should inherit from the Cat class, but its default
...
# Add your own new pets and modifications as you like – remember, to use them in the game, you’ll also have to alter
# the whichtype function so they can be used in game play. Otherwise, you’ll have different classes that may work just
# fine, but you won’t see the effects in the game, since the code that actually makes the game play is found in the
# second half of the provided code (look for the while loop!).
