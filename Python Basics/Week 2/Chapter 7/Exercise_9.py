...
# counter-clockwise.) Use a turtle to draw the path taken by our drunk friend. After the pirate is done walking, print
# the current heading. Assume that the turtle originally has a heading of 0 and accumulate the changes in heading to
# print out the final. Your solution should work for any sequence of experimental data.
